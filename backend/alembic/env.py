...
Medical Handwriting OCR project. It imports all SQLAlchemy models
...
# Import the declarative Base from our app database module
...
# This must match the Base.metadata from our app
...
def run_migrations_online() -> None:
    ...
    """
    # Allow overriding the URL via the DATABASE_URL env variable
